...
func (t *Tools) UploadFiles(r *http.Request, uploadDir string, rename ...bool) ([]*UploadedFile, error) {
	...
	err := t.CreateDirOfNotExist(uploadDir)
	if err != nil {
		return nil, err
	}
...
// CreateDirOfNotExist creates a directory, and all necessary parents, if does not exist
func (t *Tools) CreateDirOfNotExist(path string) error {
	const mode = 0755
...
// in the browser window by setting content disposition. It also allows spesification of the displayname
func (t *Tools) DownloadStaticFile(w http.ResponseWriter, r *http.Request, folderPath, fileName, displayName string) {
...
// Final parameter, client, is optional. If none is specified, we use the standart http.Client
