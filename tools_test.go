...
type RoundTripFunc func(re *http.Request) *http.Response
...
func TestTools_PushJSONToRemote(t *testing.T) {
	client := NewTestClient(func(re *http.Request) *http.Response {
...
func TestTools_CreateDirOfNotExist(t *testing.T) {
	var testTool Tools

	dirName := "./testdata/myDir"

	err := testTool.CreateDirOfNotExist(dirName)
	if err != nil {
		t.Error(err)
	}
...
func TestTools_Slugified(t *testing.T) {
	var testTool Tools
